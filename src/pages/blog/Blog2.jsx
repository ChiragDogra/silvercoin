...
const para1 = {
  ...
  text4:
    "Filing ITR allows you to claim refunds and deductions that you are entitled to. Refunds can be claimed for excess tax paid, while deductions can be claimed for expenses such as investments, donations, and medical expenses. Filing ITR on time ensures that you claim these benefits and reduce your tax liability.",
  text5:
    "Filing ITR establishes financial credibility and trustworthiness. It is a requirement for various financial transactions, such as obtaining loans, visas, and credit cards. Filing ITR on time shows that you are responsible and trustworthy, which can help you in various financial dealings. ",
  text6:
...
function blog2() {
  return (
    <div className="w-full pt-12 ">
      <div className="flex-col  align-middle items-center w-full p-5 sm:p-8 md:p-10 min-h-screen">
        ...
        <h1 className="md:text-3xl sm:text-6xl text-xl font-bold pt-3 text-center md:mt-10 md:mb-5 sm:text-left ">
