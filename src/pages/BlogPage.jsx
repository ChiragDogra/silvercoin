...
import img3 from "../assets/images/blogs/finance.svg";
import img4 from "../assets/images/blogs/productManager.svg";
import img5 from "../assets/images/blogs/startup.svg";
        ...
        <div class="container w-full px-4 flex-grow w-full py-4 sm:py-16 mx-auto px-0">
          <div class="mx-auto w-full md:w-4/5 px-4">
            <div class="container my-8 flex flex-col items-center justify-center">
              ...
              >
                <div class="flex-none w-3/4 md:w-4/6 lg:w-1/3 mr-8 md:pb-4 border rounded-lg bg-gray-100 my-4">
                  <NavLink to="blog1">
                    ...
                    <div class="px-4 py-2 ">
                      ...
                      <div class="text-lg">
                        <p class="">
                        Accounting is the process of recording, classifying and summarizing financial transaction's also one of the oldest professions in the world--accountants have been keeping 
                        </p>
                ...
                <div class="flex-none w-3/4 md:w-4/6 lg:w-1/3 mr-8 md:pb-4 border rounded-lg bg-gray-100 my-4">
                  <NavLink to="blog2">
                    ...
                    <div class="px-4 py-2 ">
                      ...
                      <div class="text-lg">
                        <p class="">
                        Filing Income Tax Returns (ITR) is an essential part of financial planning and compliance in India. It is a legal requirement for every citizen who 
                        </p>
                        <p class="font-medium text-sm text-indigo-600 mt-2">
                          Read more<span class="text-indigo-600">&hellip;</span>
                        </p>
                ...
                <div class="flex-none w-3/4 md:w-4/6 lg:w-1/3 mr-8 md:pb-4 border rounded-lg bg-gray-100 my-4">
                  <NavLink to="blog3">
                    ...
                    <div class="px-4 py-2 ">
                      ...
                      <div class="text-lg">
                        <p class="">
                          India has become a hotbed for startup growth in recent
                          years. According to a report by NASSCOM, India is the
                ...
                <div class="flex-none w-3/4 md:w-4/6 lg:w-1/3 mr-8 md:pb-4 border rounded-lg bg-gray-100 my-4">
                  <NavLink to="blog4">
                    ...
                    <div class="px-4 py-2 ">
                      ...
                      <div class="text-lg">
                        <p class="">
                          India is a country with a vast population and a
                          growing economy. This makes it an idealmarket for
                          startups in various sectors, includin
                        </p>
                        <p class="font-medium text-sm text-indigo-600 mt-2">
                          Read more<span class="text-indigo-600">&hellip;</span>
                        </p>
                ...
                <div class="flex-none w-3/4 md:w-4/6 lg:w-1/3 mr-8 md:pb-4 border rounded-lg bg-gray-100 my-4">
                  <NavLink to="blog5">
                    ...
                    <div class="px-4 py-2 ">
                      ...
                      <div class="text-lg">
                        <p class="">
                          Managing your finances can be a complex and
                          challenging task, especially if you lack the knowledge
                          and expertise in financial managemen
                        </p>
                        <p class="font-medium text-sm text-indigo-600 mt-2">
                          Read more<span class="text-indigo-600">&hellip;</span>
                        </p>
